...
| **Amazon S3 + Cloudfront (Frontend)** | Hosts the built static PWA assets. Provides durable, low-cost static hosting for the app bundle. |
...
4. Service Worker caches assets for fast loads & offline mode.
